...
const scrollUp = () => {
    ...
    if (this.scrollY >= 250) {
        scrollTop.classList.remove("-bottom-1/2");
        scrollTop.classList.add("bottom-4");
    } else {
        scrollTop.classList.add("-bottom-1/2");
...
sr.reveal(`.home__data, .about__data, .popular__data, .review__data, .review__swiper, .footer__icon, .footer__content, .copy_right` )
...
sr.reveal(`.about__item__2-content, .about__item__1-img`, {origin:"right"})
